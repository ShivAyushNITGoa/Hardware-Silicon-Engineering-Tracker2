...
export const initialInstitutions: InstitutionInternship[] = [
  ...
  // 1. IIT Madras
  {
    ...
    domains: ['RISC-V & Processor Architecture', 'VLSI & RTL Design', 'Hardware Security & Cryptography', 'Embedded Systems & IoT'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['SHAKTI RISC-V Processor', 'DIR-V Microarchitecture', 'Hardware Trojan Detection']
      },
      {
        ...
        keyProjectsOrTopics: ['FPGA DSP Accelerators', 'High-Speed Arithmetic Units']
      },
      {
        ...
        keyProjectsOrTopics: ['Spectre/Meltdown Mitigation in RISC-V', 'Fault Injection Testing']
      }
    ],
  ...
  // 2. IIT Bombay
  {
    ...
    domains: ['VLSI & RTL Design', 'Nanoelectronics & Device Physics', 'EDA Tools & Open-Source Silicon', 'Hardware Security & Cryptography'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Sub-Microwatt Biomedical Readout ICs', 'Power Management ICs (PMIC)']
      },
      {
        ...
        keyProjectsOrTopics: ['Non-Volatile AI Hardware', 'Synaptic Transistor Arrays']
      },
      {
        ...
        keyProjectsOrTopics: ['FPGA Accelerated Solvers', 'Custom Arithmetic Co-Processors']
      }
    ],
    applicationStrategyTips: [
  ...
  // 3. IIT Delhi
  {
    ...
    domains: ['VLSI & RTL Design', 'RISC-V & Processor Architecture', 'Embedded Systems & IoT', 'EDA Tools & Open-Source Silicon'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Tejas Architectural Simulator', '3D Die-Stacked NoC', 'Hardware Security']
      },
      {
        ...
        keyProjectsOrTopics: ['Smart Cane Technology', 'System-on-Chip Emulation']
      },
      {
        ...
        keyProjectsOrTopics: ['Multi-Gigabit SerDes Transceivers', 'Ultra-Low-Power SAR ADCs']
      }
    ],
    applicationStrategyTips: [
  ...
  // 4. IIT Roorkee
  {
    ...
    domains: ['VLSI & RTL Design', 'Nanoelectronics & Device Physics', 'Embedded Systems & IoT', 'Hardware Security & Cryptography'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Low-Voltage SRAM Design', 'Sub-Threshold CMOS Logic']
      },
      {
        ...
        keyProjectsOrTopics: ['2D FET Device Simulations', 'Nanowire Transistor Reliability']
      },
      {
        ...
        keyProjectsOrTopics: ['Magnetic RAM (MRAM) Logic', 'High-Speed Interconnect Modeling']
      }
    ],
    applicationStrategyTips: [
  ...
  // 5. IIT Hyderabad
  {
    ...
    domains: ['VLSI & RTL Design', 'Neuromorphic & Edge AI', 'RISC-V & Processor Architecture', 'Embedded Systems & IoT'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Through-Silicon Via (TSV) 3D Stacking', 'MEMS Sensor Integration']
      },
      {
        ...
        keyProjectsOrTopics: ['On-Chip ECG Classification ASICs', 'Low-Complexity Neural Accelerators']
      }
    ],
    applicationStrategyTips: [
  ...
  // 6. IIT Gandhinagar
  {
    ...
    domains: ['VLSI & RTL Design', 'Embedded Systems & IoT', 'Nanoelectronics & Device Physics', 'Neuromorphic & Edge AI'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Sub-5nm Transistor Reliability', 'Ferroelectric Memory Devices']
      },
      {
        ...
        keyProjectsOrTopics: ['Gaze-Tracking Embedded System', 'Robotic Rehabilitation Interfaces']
      }
    ],
    applicationStrategyTips: [
  ...
  // 7. IIT Kanpur
  {
    ...
    domains: ['VLSI & RTL Design', 'RISC-V & Processor Architecture', 'Nanoelectronics & Device Physics', 'Hardware Security & Cryptography'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Cryptographic Hardware Accelerators', 'Side-Channel Secure Co-Processors']
      },
      {
        ...
        keyProjectsOrTopics: ['Graphene & MoS2 Transistors', 'Wide Bandgap Semiconductor Modeling']
      },
      {
        ...
        keyProjectsOrTopics: ['Brain-Inspired Memory Arrays', 'In-Memory Computing Architectures']
      }
    ],
    applicationStrategyTips: [
  ...
  // 8. IIT Kharagpur
  {
    ...
    domains: ['VLSI & RTL Design', 'EDA Tools & Open-Source Silicon', 'Embedded Systems & IoT', 'Hardware Security & Cryptography'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Testing of VLSI Circuits', 'Quantum Logic Synthesis', 'Hardware PUFs']
      },
      {
        ...
        keyProjectsOrTopics: ['Side-Channel Analysis of AES/ECC', 'Hardware Trojan Detection in ASICs']
      },
      {
        ...
        keyProjectsOrTopics: ['Sub-mW Neural Signal Processors', 'Memristive Deep Learning Chips']
      }
    ],
    applicationStrategyTips: [
  ...
  // 9. IIT Guwahati
  {
    ...
    domains: ['VLSI & RTL Design', 'Nanoelectronics & Device Physics', 'Embedded Systems & IoT', 'Neuromorphic & Edge AI'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Bio-Potential Sensor ASICs', 'MEMS Acoustic Sensors']
      },
      {
        ...
        keyProjectsOrTopics: ['Analog Fault Diagnosis', 'Hardware Cryptographic Engines']
      }
    ],
    applicationStrategyTips: [
  ...
  // 10. IIT BHU Varanasi
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'VLSI & RTL Design', 'Silicon Photonics & MEMS', 'Embedded Systems & IoT'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Metal-Oxide Semiconductor Photodetectors', 'Novel Nanoscale Transistors']
      },
      {
        ...
        keyProjectsOrTopics: ['Millimeter-Wave RF Front-Ends', 'Sub-THz Waveguides']
      }
    ],
    applicationStrategyTips: [
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Ultra-Low Power SRAM for IoT', 'In-Memory Computing Accelerators']
      },
      {
        ...
        keyProjectsOrTopics: ['Resistive Switching Memories', 'Flexible Thin-Film Electronics']
      }
    ],
    applicationStrategyTips: [
  ...
  // 12. IIT Bhubaneswar
  {
    ...
    domains: ['VLSI & RTL Design', 'Embedded Systems & IoT', 'Nanoelectronics & Device Physics', 'Silicon Photonics & MEMS'],
  ...
  // 14. IIT Patna
  {
    ...
    domains: ['VLSI & RTL Design', 'Embedded Systems & IoT', 'Hardware Security & Cryptography', 'Nanoelectronics & Device Physics'],
  ...
  // 15. IIT Jodhpur
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'Silicon Photonics & MEMS', 'VLSI & RTL Design', 'Neuromorphic & Edge AI'],
  ...
  // 16. IIT Tirupati & Palakkad
  {
    ...
    domains: ['VLSI & RTL Design', 'Embedded Systems & IoT', 'Nanoelectronics & Device Physics', 'RISC-V & Processor Architecture'],
  ...
  // ==========================================
  // 2. IISC & PREMIER NATIONAL RESEARCH
  // ==========================================
  ...
  // 17. IISc Bangalore
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'VLSI & RTL Design', 'Neuromorphic & Edge AI', 'Silicon Photonics & MEMS'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['3nm/2nm Gate-All-Around (GAA) FETs', 'Kilovolt GaN High-Power Switches']
      },
      {
        ...
        keyProjectsOrTopics: ['Event-Driven Neuromorphic Vision Processors', 'Memristive Deep Learning Accelerators']
      },
      {
        ...
        keyProjectsOrTopics: ['Semiconductor Thin-Films', 'GaN on Silicon Wafer Growth']
      }
    ],
    applicationStrategyTips: [
  ...
  // 18. TIFR Mumbai
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'Silicon Photonics & MEMS', 'Neuromorphic & Edge AI'],
  ...
  // 20. SNBNCBS Kolkata
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'Silicon Photonics & MEMS'],
  ...
  // ==========================================
  // 3. NATIONAL R&D LABS, DEFENSE & SPACE
  // ==========================================

  // 21. CSIR-CEERI Pilani
  {
  ...
  // 22. C-DAC (Centre for Development of Advanced Computing)
  {
    id: 'cdac-vega-riscv',
  ...
  // 23. SCL Mohali
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'VLSI & RTL Design', 'Silicon Photonics & MEMS'],
  ...
  // 24. DRDO SSPL Delhi
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'Silicon Photonics & MEMS', 'VLSI & RTL Design'],
  ...
  // 25. ISRO (SAC Ahmedabad & URSC Bengaluru)
  {
  ...
  // ==========================================
  // 4. IIITS & PREMIER TECHNICAL UNIVERSITIES
  // ==========================================
  ...
  // 26. IIIT Hyderabad
  {
    ...
    domains: ['Neuromorphic & Edge AI', 'VLSI & RTL Design', 'Embedded Systems & IoT', 'RISC-V & Processor Architecture'],
  ...
  // 27. IIIT Bangalore
  {
    ...
    domains: ['EDA Tools & Open-Source Silicon', 'RISC-V & Processor Architecture', 'VLSI & RTL Design', 'Hardware Security & Cryptography'],
    ...
    notableFacultyAndLabs: [
      {
        ...
        keyProjectsOrTopics: ['Open-Source RISC-V SoCs', 'SkyWater 130nm ASIC Tape-Outs', 'Compute-in-Memory']
      },
      {
  ...
  // 28. IIIT Delhi
  {
    ...
    domains: ['VLSI & RTL Design', 'Neuromorphic & Edge AI', 'Embedded Systems & IoT', 'Hardware Security & Cryptography'],
  ...
  // 29. IIIT Allahabad
  {
    ...
    domains: ['VLSI & RTL Design', 'Nanoelectronics & Device Physics', 'Embedded Systems & IoT'],
  ...
  // 30. BITS Pilani (Pilani, Goa, Hyderabad)
  {
    ...
    domains: ['VLSI & RTL Design', 'Nanoelectronics & Device Physics', 'Silicon Photonics & MEMS', 'Embedded Systems & IoT'],
  ...
  // ==========================================
  // 5. TOP NATIONAL INSTITUTES OF TECHNOLOGY (NITS)
  // ==========================================
  ...
  // 31. NIT Trichy
  {
    ...
    domains: ['VLSI & RTL Design', 'Embedded Systems & IoT', 'Nanoelectronics & Device Physics', 'Hardware Security & Cryptography'],
  ...
  // 33. NIT Warangal
  {
    ...
    domains: ['VLSI & RTL Design', 'RISC-V & Processor Architecture', 'Embedded Systems & IoT'],
  ...
  // ==========================================
  // 6. NATIONAL ACADEMY FELLOWSHIPS
  // ==========================================

  // 37. IASc-INSA-NASI National Fellowship
  {
    ...
    domains: ['Nanoelectronics & Device Physics', 'VLSI & RTL Design', 'Silicon Photonics & MEMS', 'Hardware Security & Cryptography'],
...
export interface AcademicColdEmailTemplate {
  id: string;
  targetRole: string;
  subject: string;
  body: string;
...
export const academicColdEmailTemplates: AcademicColdEmailTemplate[] = [
  {
    id: 'iit-prof-vlsi',
    targetRole: 'IIT / IISc Professor (VLSI, RTL & Processor Architecture)',
    subject: 'Summer Research Internship Inquiry: Synthesizable RV32I Core & UVM Verification — [Your Name] ([Your College])',
    body: `Respected Prof. [Professor Last Name],

I hope this email finds you well.

I have been closely following your lab's pioneering research at [Lab Name, e.g., RISE Lab / Neuronics Lab, IIT Madras/IISc], specifically your recent paper on "[Mention a specific paper title or topic, e.g., Fault-Tolerant Microarchitecture / Neuromorphic Event-Based Accelerators]".

I am a [2nd/3rd]-year undergraduate student in [Your Branch] at [Your College] (CGPA: [Your CGPA]/10.0, [Rank in batch, e.g., Top 5%]). I am deeply passionate about digital VLSI design, processor microarchitecture, and formal hardware verification.

Rather than only theoretical coursework, I have engineered and benchmarked real synthesizable silicon architectures:
• 5-Stage Pipelined RV32I Core (SystemVerilog): Built complete hazard detection & ALU forwarding network; verified with 100% pass on official RISC-V compliance test suites in Verilator (Waveforms & RTL: [GitHub Link]).
• UVM Testbench Environment: Designed complete SystemVerilog UVM verification environment with transaction scoreboards and functional coverage metrics (GitHub: [GitHub Link]).
• EDA Flow Experience: Hands-on experience with Verilator, Synopsys/Cadence tools, OpenLane RTL-to-GDSII, and FPGA emulation on Xilinx Artix-7 boards.

I would be deeply honored to contribute as a Summer Research Intern in your group for 8–10 weeks (May – July [Year]). I am prepared to dedicate 40+ hours per week on-campus and can also apply through the official [Institute Fellowship Name, e.g., IITM SFP / SPARK / SURE] portal.

I have attached my 1-page CV and summary of verification waveforms. I would be grateful for the opportunity to discuss how I can contribute to your ongoing projects.

Thank you very much for your time and consideration.

Respectfully yours,
[Your Name]
B.Tech [Branch], [Your College]
Phone: [Your Phone] | LinkedIn: [Your Profile] | GitHub: [Your GitHub]`,
    strategyNotes: [
      'Keep email under 250 words so busy professors can read it on mobile.',
      'Never send generic mass emails; always customize the specific paper title and lab name in the first paragraph.',
      'Provide immediate clickable proof of work (GitHub repo with README and simulation waveform screenshots).'
    ]
  },
  {
    id: 'iit-prof-nanoelectronics',
    targetRole: 'IISc / IIT / NIT Professor (Nanoelectronics, Device Physics & Cleanroom Fab)',
    subject: 'Research Internship Request: TCAD Device Simulation & GaN/FinFET Modeling — [Your Name]',
    body: `Respected Prof. [Professor Last Name],

I am writing to express my strong interest in pursuing research under your mentorship at [Department/Center, e.g., CeNSE / DESE, IISc Bangalore / EEE Dept, IIT Guwahati] for the upcoming summer [Year].

I have carefully read your recent work on "[Mention specific topic, e.g., ESD Protection in GaN Power Devices / Gate-All-Around GAAFET Sub-3nm Reliability]" and was inspired by your approach to [mention specific finding or technique].

I am a [2nd/3rd]-year student in [ECE/EEE/Physics] at [Your College] with a CGPA of [Your CGPA]/10.0. My background includes:
• Device Physics & TCAD: Experience with semiconductor device modeling, energy band diagrams, and 2D/3D numerical drift-diffusion simulations in Synopsys Sentaurus / Silvaco.
• SPICE Circuit Modeling: Parameter extraction and non-linear macromodeling in LTspice and Cadence Virtuoso.
• Cleanroom Fundamentals: Completed theoretical training on photolithography, thin-film sputtering, and CV/IV parameter extraction.

I am eager to contribute to your group's experimental or numerical device simulation efforts this summer. I am available for 8 to 12 weeks full-time and am self-motivated to assist your PhD researchers.

Please find my CV attached for your kind review. I look forward to hearing from you.

Thank you for your guidance.

Sincerely,
[Your Name]
[Your College] | Phone: [Your Phone] | LinkedIn: [Your Profile]`,
    strategyNotes: [
      'Showcase clear mathematical and physics foundation in semiconductor equations.',
      'Explicitly state familiarity with tools like TCAD, Silvaco, or LTspice.',
      'Attach a clean 1-page CV highlighting your coursework and lab grades.'
    ]
  },
  {
    id: 'national-lab-scientist',
    targetRole: 'DRDO / ISRO / CSIR-CEERI Scientist (Space & Defense Silicon / MEMS)',
    subject: 'Application for Student Research Traineeship: Space-Grade RTL Design & FPGA Emulation — [Your Name]',
    body: `Respected Scientist / Division Head [Scientist Name / Division Title],

I hope this email finds you well.

I am writing to express my keen aspiration to undergo Student Project Training / Research Internship at [Lab Name, e.g., DRDO SSPL / ISRO SAC / CSIR-CEERI Pilani / SCL Mohali] in the domain of [Specific Domain, e.g., Space-Grade ASIC Verification / Wide Bandgap GaN Device Modeling / 180nm CMOS Foundry Processing].

I am a [3rd/4th]-year B.Tech student in [ECE/EEE] at [Your College] with a CGPA of [Your CGPA]/10.0. I have developed strong competencies in:
• Digital Hardware & Verification: Synthesizable Verilog/SystemVerilog RTL, Triple Modular Redundancy (TMR) fault tolerance, and UVM-based simulation testbenches.
• FPGA Emulation & Embedded Toolchains: Prototyping on Xilinx Artix-7/Zynq FPGAs, Vivado timing closure, and bare-metal C driver development.
• Institutional Clearance: My college Principal and HOD have approved my candidature and will issue an official No Objection Certificate (NOC) and bonafide letter upon selection.

I am deeply motivated by national self-reliance in semiconductors (Aatmanirbhar Bharat) and would consider it a privilege to contribute to your division's mission-critical hardware tasks for [6-8 weeks summer / 6-month final semester].

Please find attached my detailed CV, NOC draft, and academic transcripts.
...
Phone: [Your Phone] | Email: [Your Email]`,
    strategyNotes: [
      'Highlight compliance with national laboratory requirements (official institutional NOC and bonafide letter).',
      'Demonstrate practical skills in fault-tolerant computing (TMR), radiation hardening concepts, or cleanroom processes.',
      'Maintain a formal, professional tone suitable for senior defense/space research scientists.'
    ]
  }
];

export const sopWritingGuidelines = {
  title: 'Blueprint for a Winning Research Statement of Purpose (SOP) for IITs & IISc',
  structure: [
    {
      section: '1. The Hook & Specific Research Focus (1 Paragraph)',
      description: 'State clearly which specific sub-domain you want to investigate (e.g., RISC-V Out-of-Order Execution, Compute-in-Memory RRAM, GaN Power Devices). Name the lab and explain why their specific research problem resonates with your ambitions.'
    },
    {
      section: '2. Concrete Proof of Technical Preparation (2 Paragraphs)',
      description: 'Highlight real hardware projects rather than generic coursework. Reference your 5-stage pipeline, UVM testbench, FPGA clock crossing FIFO, or TCAD simulations. Mention specific tools (Verilog, Verilator, Synopsys, Cadence Virtuoso, C++, Python).'
    },
    {
      section: '3. Alignment with Faculty Research & Ongoing Grants (1 Paragraph)',
      description: 'Reference 1 or 2 recent publications from the target institute\'s department (from IEEE TCAS, ISSCC, TVLSI, or IEDM). Explain how your background will accelerate their deliverables.'
    },
    {
      section: '4. Concrete Summer Deliverable & Future Academic Goals (1 Paragraph)',
      description: 'State your measurable goal for the 8-10 week tenure (e.g., "author an IEEE conference paper", "synthesize a tape-out ready IP block", "implement formal proof assertions"). Conclude with your ambition to pursue master\'s/doctoral research in semiconductors.'
    }
  ],
  commonMistakesToAvoid: [
    'Do not write generic life stories or talk about childhood fascination with computers.',
    'Do not copy-paste generic SOPs across different IITs; each institute has unique strengths (e.g., Shakti at IIT Madras, CeNSE cleanroom at IISc, Tejas at IIT Delhi, DIR-V at C-DAC).',
    'Do not make claims without GitHub or project report proof.'
  ]
};
