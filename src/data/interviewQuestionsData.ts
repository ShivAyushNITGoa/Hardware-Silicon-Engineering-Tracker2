...
export const interviewQuestions: InterviewQuestion[] = [
  // 1. STA & Timing
  {
    ...
    category: 'STA & Timing',
    difficulty: 'Core',
    companies: ['Qualcomm', 'Texas Instruments', 'Intel', 'NVIDIA'],
  ...
  },
  {
    ...
    category: 'STA & Timing',
    difficulty: 'Advanced',
    companies: ['Texas Instruments', 'Qualcomm', 'AMD'],
  ...
  },
  {
    ...
    category: 'STA & Timing',
    difficulty: 'Crucial',
    companies: ['Qualcomm', 'Intel', 'NVIDIA', 'InCore'],
  ...
  },
  {
    ...
    category: 'STA & Timing',
    difficulty: 'Advanced',
    companies: ['Synopsys', 'Cadence', 'Qualcomm'],
  ...
  // 2. SystemVerilog RTL
  {
    ...
    difficulty: 'Core',
    companies: ['Texas Instruments', 'Qualcomm', 'Intel', 'AMD'],
...
always_ff @(posedge clk) begin
  ...
  },
  {
    ...
    category: 'SystemVerilog RTL',
    difficulty: 'Core',
    companies: ['NVIDIA', 'Qualcomm', 'Mindgrove', 'InCore'],
...
always_comb begin
  ...
  },
  {
    ...
    category: 'SystemVerilog RTL',
    difficulty: 'Crucial',
    companies: ['NVIDIA', 'Qualcomm', 'Intel', 'InCore'],
...
endtask`,
  ...
  },
  {
    ...
    category: 'ASIC Verification & UVM',
    difficulty: 'Advanced',
    companies: ['Qualcomm', 'Texas Instruments', 'NVIDIA', 'AMD'],
...
assert_req_ack: assert property(p_req_ack_handshake)
  ...
  },
  {
    ...
    category: 'ASIC Verification & UVM',
    difficulty: 'Core',
    companies: ['Cadence', 'Synopsys', 'Tessolve', 'Intel'],
  ...
  },
  {
    ...
    category: 'RISC-V Architecture',
    difficulty: 'Advanced',
    companies: ['InCore', 'Mindgrove', 'Western Digital', 'Tenstorrent'],
...
void uart_putc(char c) {
  ...
  },
  {
    ...
    category: 'Embedded C & FreeRTOS',
    difficulty: 'Core',
    companies: ['Texas Instruments', 'NXP', 'Microchip', 'Tonbo Imaging'],
  ...
  // 6. Protocols & Buses
  {
    ...
    difficulty: 'Advanced',
    companies: ['Xilinx/AMD', 'ARM', 'Qualcomm', 'Intel'],
  ...
  },
  {
    ...
    category: 'Protocols & Buses',
    difficulty: 'Core',
    companies: ['Texas Instruments', 'NXP', 'Microchip', 'Saankhya Labs'],
  ...
  // 7. Embedded Linux & Kernel
  {
    ...
    difficulty: 'Crucial',
    companies: ['Qualcomm', 'NXP', 'Texas Instruments', 'Ambarella'],
  ...
  // 10. DFT & Silicon Test
  {
    ...
    difficulty: 'Advanced',
    companies: ['Intel', 'Qualcomm', 'AMD', 'MediaTek'],
