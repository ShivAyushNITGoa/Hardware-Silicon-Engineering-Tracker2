    ...
    "topics": [
        ...
        "subtopics": [
          {
            ...
            "detail": "Pointer dereferencing, casting integer addresses to volatile register pointers."
          },
          {
            "id": "ec-1-2",
            "title": "Bitwise Masking & Bit Shifts",
            "detail": "Set, clear, toggle, and test specific register bitfields without side effects."
          },
          {
            "id": "ec-1-3",
            "title": "Volatile Keyword Semantics",
            "detail": "Prevent compiler optimization on memory-mapped hardware I/O and shared ISR variables."
          },
          {
            "id": "ec-1-4",
            "title": "Struct Packing & Memory Alignment",
            "detail": "Prevent compiler padding issues when mapping telemetry packet buffers."
          },
          {
            "id": "ec-1-5",
            "title": "Exit Gate: C Memory & Bitwise Test",
            "detail": "Pass the timed C memory manipulation exam.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ec-2-1",
            "title": "GPIO Configuration & Edge Triggers",
            "detail": "Configure input/output, pull-up/pull-down, open-drain, and edge interrupts."
          },
          {
            "id": "ec-2-2",
            "title": "Hardware Timers & PWM Channels",
            "detail": "Configure prescalers, period registers, and duty cycles for actuators and precise timebases."
          },
          {
            "id": "ec-2-3",
            "title": "ADC Sampling & Calibration",
            "detail": "Understand reference voltage, resolution, attenuation, and sampling non-linearities."
          },
          {
            "id": "ec-2-4",
            "title": "Serial Interfaces: UART, SPI & I2C",
            "detail": "Implement master SPI transactions and I2C address/acknowledgement timing."
          },
          {
            "id": "ec-2-5",
            "title": "Exit Gate: Multi-Peripheral Driver Suite",
            "detail": "Loopback and verify all 4 peripherals simultaneously.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ec-3-1",
            "title": "ISR Safety Rules",
            "detail": "Keep ISRs minimal: no blocking delays, no dynamic allocation, no heavy I/O."
          },
          {
            "id": "ec-3-2",
            "title": "Atomic Operations & Critical Sections",
            "detail": "Protect shared multi-byte variables using interrupt disable/enable masks."
          },
          {
            "id": "ec-3-3",
            "title": "Hardware Watchdog Timer (WDT)",
            "detail": "Configure task and windowed watchdogs to recover cleanly from infinite loops."
          },
          {
            "id": "ec-3-4",
            "title": "Exit Gate: Oscilloscope ISR Timing Proof",
            "detail": "Demonstrate <5us ISR latency on an oscilloscope or logic analyzer.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ec-4-1",
            "title": "HAL & Driver Separation",
            "detail": "Decouple low-level chip register access from high-level sensor business logic."
          },
          {
            "id": "ec-4-2",
            "title": "Table-Driven State Machines in C",
            "detail": "Implement state tables with function pointers for deterministic state transitions."
          },
          {
            "id": "ec-4-3",
            "title": "Graceful Error Handling Enums",
            "detail": "Return descriptive status codes instead of silent magic numbers."
          },
          {
            "id": "ec-4-4",
            "title": "Exit Gate: Modular Refactor Verification",
            "detail": "Swap physical sensor pins with zero application code changes.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ec-5-1",
            "title": "GDB & Breakpoint Navigation",
            "detail": "Set hardware watchpoints, step into disassembly, and inspect memory addresses."
          },
          {
            "id": "ec-5-2",
            "title": "HardFault Handler Analysis",
            "detail": "Read Link Register (LR), Program Counter (PC), and Configurable Fault Status (CFSR)."
          },
          {
            "id": "ec-5-3",
            "title": "Structured Log Levels",
            "detail": "Implement compile-time adjustable DEBUG, INFO, WARN, and ERROR log streams."
          },
          {
            "id": "ec-5-4",
            "title": "Exit Gate: HardFault Root Cause Report",
            "detail": "Analyze and document a crash log with exact faulting line identification.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ec-6-1",
            "title": "Task Creation & Priority Sizing",
            "detail": "Configure stack size, priorities, and vTaskDelayUntil for deterministic periods."
          },
          {
            "id": "ec-6-2",
            "title": "Inter-Task Communication via Queues",
            "detail": "Pass data structures safely between producer and consumer tasks without globals."
          },
          {
            "id": "ec-6-3",
            "title": "Mutexes & Priority Inheritance",
            "detail": "Protect shared I2C/SPI buses from priority inversion bugs."
          },
          {
            "id": "ec-6-4",
            "title": "Exit Gate: 3-Task Concurrent FreeRTOS Build",
            "detail": "Run 24-hour test with zero stack overflows and zero task starvations.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "rtl-1-1",
            "title": "Spatial Concurrency vs Sequential Flow",
            "detail": "Understand that all hardware always blocks evaluate simultaneously in parallel."
          },
          {
            "id": "rtl-1-2",
            "title": "Flip-Flops vs Latches",
            "detail": "Avoid incomplete case/if statements that infer dangerous transparent latches."
          },
          {
            "id": "rtl-1-3",
            "title": "Assignment Rules (= vs <=)",
            "detail": "Strict rule: use <= in clocked sequential blocks, = in pure combinational blocks."
          },
          {
            "id": "rtl-1-4",
            "title": "Exit Gate: Zero-Latch Synthesis Proof",
            "detail": "Synthesize 5 modules and verify 0 inferred latches in synthesis log.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "rtl-2-1",
            "title": "always_comb and always_ff Enforcements",
            "detail": "Compiler guarantees simulation-synthesis consistency by checking sensitivity lists."
          },
          {
            "id": "rtl-2-2",
            "title": "Typedef Enums for Hardware States",
            "detail": "Define explicit state names and encoding (one-hot, gray, binary)."
          },
          {
            "id": "rtl-2-3",
            "title": "Parameterized Modules (generics)",
            "detail": "Create bit-width agile arithmetic and register modules."
          },
          {
            "id": "rtl-2-4",
            "title": "Exit Gate: Clean Lint & Test Suite",
            "detail": "Pass Verilator lint checks with zero warnings across 10 modules.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "rtl-3-1",
            "title": "Moore vs Mealy Output Timing",
            "detail": "Understand 1-cycle latency vs zero-cycle combinational glitch risks."
          },
          {
            "id": "rtl-3-2",
            "title": "3-Always Block FSM Template",
            "detail": "State register, next-state logic, and registered output logic cleanly decoupled."
          },
          {
            "id": "rtl-3-3",
            "title": "One-Hot vs Binary Encoding Tradeoffs",
            "detail": "Optimize for FPGA LUT resources vs high-frequency ASIC timing."
          },
          {
            "id": "rtl-3-4",
            "title": "Exit Gate: Glitch-Free Protocol FSM",
            "detail": "Simulate UART FSM and prove glitch-free registered output waveforms.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "rtl-4-1",
            "title": "Pointer Rollover & MSB Wrap Bit",
            "detail": "Use extra MSB bit to distinguish full from empty conditions cleanly."
          },
          {
            "id": "rtl-4-2",
            "title": "Ready/Valid Handshake Protocol",
            "detail": "Implement standard AXI-Stream compatible backpressure flow control."
          },
          {
            "id": "rtl-4-3",
            "title": "Watermark Thresholds",
            "detail": "Generate programmable almost_full flag for flow control pacing."
          },
          {
            "id": "rtl-4-4",
            "title": "Exit Gate: Full FIFO Testbench Pass",
            "detail": "Run 100,000 random write/read cycles with zero transaction errors.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "rtl-5-1",
            "title": "Reset Removal & Recovery Violations",
            "detail": "Implement a reset bridge (async assert, sync deassert)."
          },
          {
            "id": "rtl-5-2",
            "title": "Metastability & 2-FF Synchronizer",
            "detail": "Synchronize 1-bit control signals safely across asynchronous clock domains."
          },
          {
            "id": "rtl-5-3",
            "title": "Gray Code Pointers for Async FIFOs",
            "detail": "Ensure only 1 bit flips per clock cycle across multi-bit domain crossings."
          },
          {
            "id": "rtl-5-4",
            "title": "Exit Gate: Async FIFO Silicon Proof",
            "detail": "Simulate cross-clock transactions with mismatched clock frequencies (e.g. 50MHz to 148.5MHz).",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "fpga-1-1",
            "title": "LUT6 as 64-bit ROM / Function Table",
            "detail": "Understand how any 6-input boolean equation maps to 1 physical LUT."
          },
          {
            "id": "fpga-1-2",
            "title": "Dedicated Carry Chains (CARRY8)",
            "detail": "Understand high-speed hardware fast carry lookahead logic for adders/comparators."
          },
          {
            "id": "fpga-1-3",
            "title": "Dedicated Clock Buffers & PLLs",
            "detail": "Use MMCME4 / PLLE4 primitives for low-jitter clock synthesis and phase alignment."
          },
          {
            "id": "fpga-1-4",
            "title": "Exit Gate: Primitive Mapping Verification",
            "detail": "Map a 32-bit counter and predict slice count within 5% accuracy.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "fpga-2-1",
            "title": "Project vs Non-Project Batch Tcl Mode",
            "detail": "Run vivado -mode batch -source build.tcl for automated CI/CD."
          },
          {
            "id": "fpga-2-2",
            "title": "Synthesis Strategies",
            "detail": "Compare AreaOptimized, Flow_PerfOptimized, and RuntimeOptimized."
          },
          {
            "id": "fpga-2-3",
            "title": "Implementation & Routing Stages",
            "detail": "Understand opt_design, place_design, phys_opt_design, and route_design."
          },
          {
            "id": "fpga-2-4",
            "title": "Exit Gate: Clean Bitstream Generation",
            "detail": "Produce a 0-critical-warning bitstream for an FPGA board.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "fpga-3-1",
            "title": "Primary Clock Constraints",
            "detail": "Define create_clock -period 10.000 [get_ports sys_clk] with duty cycle."
          },
          {
            "id": "fpga-3-2",
            "title": "I/O Pin Standard & Slew Rate",
            "detail": "Set IOSTANDARD LVCMOS33, DRIVE 8, SLEW FAST on output ports."
          },
          {
            "id": "fpga-3-3",
            "title": "Timing Exceptions",
            "detail": "Apply set_false_path to asynchronous button inputs and static config pins."
          },
          {
            "id": "fpga-3-4",
            "title": "Exit Gate: Timing Clean Implementation",
            "detail": "Achieve Worst Negative Slack (WNS) >= 0.000ns at target clock frequency.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "fpga-4-1",
            "title": "Setup Time Inequality",
            "detail": "Tclk >= Tcq + Tcomb + Tsu - Tskew + Jitter."
          },
          {
            "id": "fpga-4-2",
            "title": "Hold Time Inequality",
            "detail": "Tcq + Tcomb >= Th + Tskew (Hold violations are fatal and cannot be fixed by lowering clock frequency)."
          },
          {
            "id": "fpga-4-3",
            "title": "Critical Path Retiming",
            "detail": "Move flip-flop boundaries to balance combinational delays across pipeline stages."
          },
          {
            "id": "fpga-4-4",
            "title": "Exit Gate: 100MHz+ Timing Closure Pass",
            "detail": "Close timing on a complex ALU datapath at 150MHz with positive slack.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "fpga-5-1",
            "title": "ILA Core Parameterization",
            "detail": "Set probe widths, data depth (1024 to 8192 samples), and sample clock."
          },
          {
            "id": "fpga-5-2",
            "title": "Complex Trigger Equations",
            "detail": "Trigger on state == ERROR && rx_valid == 1."
          },
          {
            "id": "fpga-5-3",
            "title": "Hardware Session Debugging",
            "detail": "Capture and inspect waveforms in Vivado Hardware Manager over JTAG."
          },
          {
            "id": "fpga-5-4",
            "title": "Exit Gate: Physical Silicon Bug Isolation",
            "detail": "Capture and document a live hardware trace of an error state.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "ca-1-1",
            "title": "Instruction Formats & Immediate Generators",
            "detail": "Decode sign-extended 12-bit and 20-bit immediates for ALU, branches, and jumps."
          },
          {
            "id": "ca-1-2",
            "title": "32x32-bit Dual-Read Single-Write Register File",
            "detail": "Implement zero-hardwired x0 register and dual asynchronous read ports."
          },
          {
            "id": "ca-1-3",
            "title": "Arithmetic Logic Unit (ALU)",
            "detail": "Implement ADD, SUB, SLT, SLTU, XOR, OR, AND, SLL, SRL, SRA operations."
          },
          {
            "id": "ca-1-4",
            "title": "Exit Gate: Decoder Testbench 100% Pass",
            "detail": "Decode all 37 RV32I opcodes with 100% testbench coverage.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ca-2-1",
            "title": "Control Unit Decoder Logic",
            "detail": "Generate RegWrite, ALUSrc, MemWrite, MemRead, Branch, Jump control signals."
          },
          {
            "id": "ca-2-2",
            "title": "Byte/Halfword/Word Load-Store Unit",
            "detail": "Handle sign-extension for LB/LBU/LH/LHU and alignment masks for SB/SH/SW."
          },
          {
            "id": "ca-2-3",
            "title": "Branch & Jump Target Calculation",
            "detail": "Calculate PC-relative offsets for BEQ, BNE, BLT, BGE and JAL/JALR."
          },
          {
            "id": "ca-2-4",
            "title": "Exit Gate: Assembly Test Suite Pass",
            "detail": "Run complete assembly test suite and verify final register values.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ca-3-1",
            "title": "Data Forwarding (EX->EX, MEM->EX)",
            "detail": "Bypass computed results directly into ALU inputs to eliminate stalls."
          },
          {
            "id": "ca-3-2",
            "title": "Load-Use Hazard Stalling",
            "detail": "Insert a 1-cycle bubble when an instruction immediately depends on a preceding LOAD."
          },
          {
            "id": "ca-3-3",
            "title": "Control Hazard Branch Flushing",
            "detail": "Flush IF/ID pipeline registers when a branch is taken (2-cycle branch penalty)."
          },
          {
            "id": "ca-3-4",
            "title": "Exit Gate: Hazard Verification Suite",
            "detail": "Execute hazard-heavy assembly program without corruption or unexpected stalls.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ca-4-1",
            "title": "Address Bus Decoder",
            "detail": "Route memory access to RAM (0x0000_0000) or Peripherals (0x8000_0000)."
          },
          {
            "id": "ca-4-2",
            "title": "C Runtime & Linker Script (.ld)",
            "detail": "Define stack pointer, text/data sections, and entry point reset vector."
          },
          {
            "id": "ca-4-3",
            "title": "Hardware Peripheral C Header Drivers",
            "detail": "Define struct pointer wrappers: #define UART ((volatile uart_t*)0x80000000)."
          },
          {
            "id": "ca-4-4",
            "title": "Exit Gate: C Code Running on Custom Silicon",
            "detail": "Execute compiled C binary on simulated CPU and verify UART character transmission.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
        ...
        "subtopics": [
          {
            ...
            "detail": "Use assert property (@(posedge clk) disable iff (!rst_n) req |-> ##[1:5] ack)."
          },
          {
            "id": "ver-1-2",
            "title": "Golden Reference Checking",
            "detail": "Compare DUT output against a simple software queue model every cycle."
          },
          {
            "id": "ver-1-3",
            "title": "Fault Injection Verification",
            "detail": "Inject 5 intentional bugs and prove 100% detection rate."
          },
          {
            "id": "ver-1-4",
            "title": "Exit Gate: Injected Fault Catch Rate 100%",
            "detail": "Catch all 5 injected bugs in simulation with zero false positives.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ver-2-1",
            "title": "cocotb Coroutines & Clocks",
            "detail": "Use Timer, RisingEdge, and Clock(dut.clk, 10, units=\"ns\").start()."
          },
          {
            "id": "ver-2-2",
            "title": "Driver & Monitor Classes in Python",
            "detail": "Decouple transaction generation from signal-level pin wiggling."
          },
          {
            "id": "ver-2-3",
            "title": "NumPy Golden Model Comparison",
            "detail": "Compare hardware FIR filter output against scipy.signal.lfilter in floating point."
          },
          {
            "id": "ver-2-4",
            "title": "Exit Gate: Python Regression Pass",
            "detail": "Run 1,000 randomized transaction packets through DUT with zero errors.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ver-3-1",
            "title": "UVM Component Hierarchy",
            "detail": "Understand uvm_driver, uvm_monitor, uvm_scoreboard, and uvm_env."
          },
          {
            "id": "ver-3-2",
            "title": "TLM Analysis Ports & FIFOs",
            "detail": "Broadcast monitored transactions to scoreboards without tight coupling."
          },
          {
            "id": "ver-3-3",
            "title": "Functional Coverage (Covergroups & Coverpoints)",
            "detail": "Track which corner cases and state combinations were actually exercised."
          },
          {
            "id": "ver-3-4",
            "title": "Exit Gate: Functional Coverage Report",
            "detail": "Achieve >90% functional coverage on target FIFO/ALU block.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "dsp-1-1",
            "title": "Sampling Rate & Anti-Aliasing",
            "detail": "Understand Fs >= 2 * Fmax and analog front-end low-pass requirements."
          },
          {
            "id": "dsp-1-2",
            "title": "Direct-Form vs Transposed-Form FIR",
            "detail": "Compare critical path and DSP slice mapping in FPGA fabric."
          },
          {
            "id": "dsp-1-3",
            "title": "Windowed Sinc Filter Design",
            "detail": "Generate Hamming/Hann windowed coefficients for sharp cutoff."
          },
          {
            "id": "dsp-1-4",
            "title": "Exit Gate: Filter Reference Model Pass",
            "detail": "Generate 16-tap low-pass filter and prove >40dB stopband attenuation.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "dsp-2-1",
            "title": "Q-Format Representation & Bit Shifts",
            "detail": "Multiply two Q4.12 numbers to get Q8.24, then scale back to Q4.12."
          },
          {
            "id": "dsp-2-2",
            "title": "Hardware Saturation Logic",
            "detail": "Prevent catastrophic overflow wrap-around by clamping to MAX_INT / MIN_INT."
          },
          {
            "id": "dsp-2-3",
            "title": "Quantization Error Analysis",
            "detail": "Quantify mean squared error (MSE) across dynamic range."
          },
          {
            "id": "dsp-2-4",
            "title": "Exit Gate: SQNR Metric Proof",
            "detail": "Demonstrate <0.5% error relative to floating-point reference.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "dsp-3-1",
            "title": "ROM Table Generation Script (Python)",
            "detail": "Generate synthesizable SystemVerilog initial memory file (.mem / .coe)."
          },
          {
            "id": "dsp-3-2",
            "title": "Linear Interpolator Hardware",
            "detail": "Y = Y0 + (X - X0) * Slope to achieve high precision with compact table."
          },
          {
            "id": "dsp-3-3",
            "title": "Pipeline Latency & Throughput Optimization",
            "detail": "Achieve 1 result per clock cycle initiation interval."
          },
          {
            "id": "dsp-3-4",
            "title": "Exit Gate: Activation Accelerator Benchmark",
            "detail": "Pass maximum absolute error < 0.01 across full test range.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
        ...
        "subtopics": [
          {
            ...
            "detail": "Extract mean, variance, peak-to-peak, and spectral energy features."
          },
          {
            "id": "ai-1-2",
            "title": "Post-Training INT8 Quantization",
            "detail": "Map 32-bit float weights and biases to 8-bit integers with zero-point scaling."
          },
          {
            "id": "ai-1-3",
            "title": "Confusion Matrix & Error Analysis",
            "detail": "Evaluate false positive / false negative rates on edge test cases."
          },
          {
            "id": "ai-1-4",
            "title": "Exit Gate: Quantized Model Accuracy Pass",
            "detail": "Preserve >95% of floating-point baseline accuracy in INT8.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "ai-2-1",
            "title": "AXI-Lite 5-Channel Architecture",
            "detail": "Read Address (AR), Read Data (R), Write Address (AW), Write Data (W), Write Response (B)."
          },
          {
            "id": "ai-2-2",
            "title": "AXI-Stream Valid/Ready Handshaking",
            "detail": "Transfer streaming packets without address overhead for maximum throughput."
          },
          {
            "id": "ai-2-3",
            "title": "Hardware/Software Partitioning Analysis",
            "detail": "Calculate memory bandwidth and PCIe/AXI transfer latency vs compute speedup."
          },
          {
            "id": "ai-2-4",
            "title": "Exit Gate: AXI Register Interface Pass",
            "detail": "C program on CPU successfully configures and reads accelerator registers.",
            "isExitGate": true
          }
        ]
      },
        ...
        "subtopics": [
          {
            ...
            "detail": "Live sensor data stream processed by FPGA accelerator in real time."
          },
          {
            "id": "ai-3-2",
            "title": "Quantified Speedup & Power Metrics",
            "detail": "Measure execution time in microseconds: CPU software vs FPGA hardware."
          },
          {
            "id": "ai-3-3",
            "title": "Technical Architecture Report & Video",
            "detail": "Record 2-minute clear technical demo video explaining architecture and results."
          },
          {
            "id": "ai-3-4",
            "title": "Exit Gate: 5/5 Successful Live Demo Runs",
            "detail": "Complete 5 live physical runs without glitches or crashes.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "iot-1-1",
            "title": "MQTT QoS Levels & Retries",
            "detail": "Choose QoS 1 for critical alarm packets and QoS 0 for high-rate sensor streams."
          },
          {
            "id": "iot-1-2",
            "title": "Local Ring-Buffer Flash Storage",
            "detail": "Spool telemetry to SPI Flash when internet is disconnected."
          },
          {
            "id": "iot-1-3",
            "title": "TLS Hardware Acceleration on ESP32-S3",
            "detail": "Use internal cryptographic engine for low-latency TLS handshakes."
          },
          {
            "id": "iot-1-4",
            "title": "Exit Gate: 1,000 Packet Stress Drop Test",
            "detail": "Verify 0 dropped packets during 10 forced network disconnections.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "iot-2-1",
            "title": "Peripheral Power Gate Controls",
            "detail": "Disable unused internal oscillators, radios, and external sensor pull-ups."
          },
          {
            "id": "iot-2-2",
            "title": "RTC Fast/Slow Memory Preservation",
            "detail": "Store rolling calibration parameters across deep sleep wakeups."
          },
          {
            "id": "iot-2-3",
            "title": "Exit Gate: <50uA Sleep Current Verification",
            "detail": "Confirm current draw with bench multimeter in sleep state.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "pwr-1-1",
            "title": "Gate Charge (Qg) & Peak Current Math",
            "detail": "I_peak = V_gate / (R_driver + R_gate_internal + R_gate_ext)."
          },
          {
            "id": "pwr-1-2",
            "title": "Dead-Time Insertion",
            "detail": "Prevent catastrophic shoot-through current in half-bridge configurations."
          },
          {
            "id": "pwr-1-3",
            "title": "Bootstrap Diode & Capacitor Sizing",
            "detail": "Ensure high-side gate driver maintains Vgs > Vth during continuous high duty cycles."
          },
          {
            "id": "pwr-1-4",
            "title": "Exit Gate: LTspice Half-Bridge Simulation",
            "detail": "Demonstrate clean switching with zero shoot-through current spikes.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "pwr-2-1",
            "title": "Inductor & Output Cap Sizing Equations",
            "detail": "L = (Vin - Vout) * Vout / (Vin * Fsw * Delta_I)."
          },
          {
            "id": "pwr-2-2",
            "title": "Transient Step-Load Analysis",
            "detail": "Measure output voltage recovery time during sudden current jumps."
          },
          {
            "id": "pwr-2-3",
            "title": "Exit Gate: LTspice Step-Load Pass",
            "detail": "Achieve <50mV output ripple at 3A load with fast settling time.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "hyg-1-1",
            "title": "EDA Artifact .gitignore Rules",
            "detail": "Filter out .jou, .log, .wdb, .vcd, and vivado transient folders."
          },
          {
            "id": "hyg-1-2",
            "title": "Unified Makefile / Tcl Scripts",
            "detail": "Implement make sim, make synth, make lint commands."
          },
          {
            "id": "hyg-1-3",
            "title": "Professional README Architecture Diagrams",
            "detail": "Create clean datapath block diagrams using Draw.io / Mermaid."
          },
          {
            "id": "hyg-1-4",
            "title": "Exit Gate: 1-Command Clean Build Proof",
            "detail": "Clone repo in fresh directory and verify single-command test execution.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "int-1-1",
            "title": "FIFO Depth Calculation Formula",
            "detail": "Calculate required depth given burst length, write rate, read rate, and read delays."
          },
          {
            "id": "int-1-2",
            "title": "Setup & Hold Time Whiteboard Derivation",
            "detail": "Derive maximum operating frequency and minimum combinational delay equations."
          },
          {
            "id": "int-1-3",
            "title": "Overlapping Sequence Detector FSM",
            "detail": "Design Moore and Mealy state diagrams for patterns like 1011 or 1101."
          },
          {
            "id": "int-1-4",
            "title": "Exit Gate: 15-Minute Timed Mock Screen",
            "detail": "Solve 3 unfamiliar digital questions with zero errors under time pressure.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "int-2-1",
            "title": "Memory-Safe Circular Buffer in C",
            "detail": "Write atomic push/pop functions handling wrap-around and overflow flags."
          },
          {
            "id": "int-2-2",
            "title": "Bitwise Optimization Algorithms",
            "detail": "Count set bits in O(k), reverse endianness, check power of two in one line."
          },
          {
            "id": "int-2-3",
            "title": "Volatile & Const Qualifier Scenarios",
            "detail": "Explain const volatile uint32_t * const reg (read-only hardware status register)."
          },
          {
            "id": "int-2-4",
            "title": "Exit Gate: Live Coding Screen Pass",
            "detail": "Solve 3 embedded C challenges in a plain text editor with 0 compilation bugs.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "lin-1-1",
            "title": "U-Boot Environment & Bootcmd",
            "detail": "Configure bootargs (console, root=/dev/mmcblk0p2, earlyprintk) and load kernel from eMMC/TFTP."
          },
          {
            "id": "lin-1-2",
            "title": "Device Tree Node Properties",
            "detail": "Specify compatible strings, reg addresses, interrupts, and clocks."
          },
          {
            "id": "lin-1-3",
            "title": "Device Tree Overlays (DTBO)",
            "detail": "Dynamically modify the live device tree to attach hardware capes and add-on sensor boards."
          },
          {
            "id": "lin-1-4",
            "title": "Exit Gate: Device Tree Hardware Binding",
            "detail": "Compile custom DTB and verify successful driver binding via compatible string.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "lin-2-1",
            "title": "Kernel vs User Space Context",
            "detail": "Safely transfer data using copy_to_user() and copy_from_user() with pointer validation."
          },
          {
            "id": "lin-2-2",
            "title": "Struct file_operations Implementation",
            "detail": "Implement non-blocking read(), write(), and unlocked_ioctl() system call handlers."
          },
          {
            "id": "lin-2-3",
            "title": "Kernel Concurrency & Spinlocks / Mutexes",
            "detail": "Protect shared kernel data structures from race conditions during concurrent user access."
          },
          {
            "id": "lin-2-4",
            "title": "Exit Gate: Zero-Panic Stress Test",
            "detail": "Run 100,000 continuous concurrent read/write ioctl operations without kernel crash.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "lin-3-1",
            "title": "Platform Driver Probe & Resource Mapping",
            "detail": "Extract IORESOURCE_MEM and map via devm_ioremap_resource() safely."
          },
          {
            "id": "lin-3-2",
            "title": "Threaded IRQ & Bottom-Half Handlers",
            "detail": "Keep top-half minimal; delegate heavy SPI/I2C transfers to threaded interrupt handler."
          },
          {
            "id": "lin-3-3",
            "title": "Sysfs & Class Device Attributes",
            "detail": "Expose runtime hardware configuration and status via /sys interface."
          },
          {
            "id": "lin-3-4",
            "title": "Exit Gate: Sysfs Sensor Driver Pass",
            "detail": "Demonstrate driver probe matching and sysfs data logging in live Linux session.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "pd-1-1",
            "title": "Liberty (.lib) Timing & Power Characterization",
            "detail": "Understand input transition, output load capacitance, and Non-Linear Delay Models (NLDM)."
          },
          {
            "id": "pd-1-2",
            "title": "Technology Mapping & Gate Optimization",
            "detail": "Map generic RTL expressions to target foundry standard cells (e.g. sky130_fd_sc_hd)."
          },
          {
            "id": "pd-1-3",
            "title": "Area vs Timing Pareto Tradeoffs",
            "detail": "Analyze cell count and maximum frequency under varying synthesis effort."
          },
          {
            "id": "pd-1-4",
            "title": "Exit Gate: Gate-Level Netlist Verification",
            "detail": "Pass 100% of testbench vectors in Gate-Level Simulation with 0 timing mismatches.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "pd-2-1",
            "title": "Core Utilization & Aspect Ratio",
            "detail": "Set target density (typically 50-65% for unrouted designs to avoid congestion)."
          },
          {
            "id": "pd-2-2",
            "title": "Power Grid (PDN) Sizing & IR Drop",
            "detail": "Calculate metal layer width and pitch to keep static and dynamic IR drop < 3% of VDD."
          },
          {
            "id": "pd-2-3",
            "title": "Well-Tap and Decoupling Capacitor Insertion",
            "detail": "Prevent CMOS latch-up with periodic tap cells and suppress voltage ripple with decap cells."
          },
          {
            "id": "pd-2-4",
            "title": "Exit Gate: DRC-Clean Floorplan DEF",
            "detail": "Achieve 0 placement violations and verified PDN continuity in OpenLane / Innovus.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "pd-3-1",
            "title": "Clock Tree Synthesis & Buffer Sizing",
            "detail": "Insert clock buffers/inverters to balance insertion delay and keep clock skew < 100ps."
          },
          {
            "id": "pd-3-2",
            "title": "Detailed Routing & Antenna Rule Fixes",
            "detail": "Route metal tracks (Met1 to Met5) and insert antenna diodes to protect gate oxides."
          },
          {
            "id": "pd-3-3",
            "title": "Physical Verification: DRC & LVS Signoff",
            "detail": "Verify spacing/width rules and exact electrical equivalence between layout and netlist."
          },
          {
            "id": "pd-3-4",
            "title": "Exit Gate: Tape-Out Ready GDSII Proof",
            "detail": "Export GDSII with 0 DRC errors, 0 LVS errors, and 0 timing violations.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "pcb-1-1",
            "title": "Power Tree & Thermal Budgeting",
            "detail": "Design multi-rail power sequencing (e.g. 12V -> 5V -> 3.3V -> 1.8V) with LDO and Buck efficiency calculations."
          },
          {
            "id": "pcb-1-2",
            "title": "ESD Protection & Input Clamping",
            "detail": "Place TVS diode arrays on USB and external connector data lines close to entry points."
          },
          {
            "id": "pcb-1-3",
            "title": "Decoupling Capacitor Network Sizing",
            "detail": "Place 0.1uF, 1uF, and 10uF ceramic capacitors with low ESR/ESL at every MCU power pin."
          },
          {
            "id": "pcb-1-4",
            "title": "Exit Gate: 100% Clean ERC Schematic",
            "detail": "Pass ERC with 0 errors, 0 unconnected pins, and complete component annotations.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "pcb-2-1",
            "title": "Layer Stackup & Ground Reference Planes",
            "detail": "Ensure continuous, unbroken ground reference planes directly adjacent to high-speed signal layers."
          },
          {
            "id": "pcb-2-2",
            "title": "Differential Pair Length Matching",
            "detail": "Tune serpentine meanders to match skew within +/- 5 mils for high-speed USB/Ethernet."
          },
          {
            "id": "pcb-2-3",
            "title": "Via Parasitics & Via Stubs",
            "detail": "Minimize capacitance and inductance by placing ground return stitching vias near signal layer transitions."
          },
          {
            "id": "pcb-2-4",
            "title": "Exit Gate: Impedance-Clean Routing Proof",
            "detail": "Complete length-matched routing of differential pairs adhering to 90Ω design rules.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "pcb-3-1",
            "title": "Return Path Discontinuity Prevention",
            "detail": "Never route high-speed traces across plane splits or slot voids to avoid massive EMI radiation."
          },
          {
            "id": "pcb-3-2",
            "title": "Crosstalk Suppression & Guard Traces",
            "detail": "Apply 3W spacing rule between aggressive clock signals and sensitive analog lines."
          },
          {
            "id": "pcb-3-3",
            "title": "Design for Manufacturing (DFM) Signoff",
            "detail": "Enforce minimum annular ring, trace spacing, solder mask clearance, and silkscreen readability."
          },
          {
            "id": "pcb-3-4",
            "title": "Exit Gate: SMT-Ready Manufacturing Pack",
            "detail": "Generate complete Gerber, Drill, BOM, and CPL files validated in Gerber viewer.",
            "isExitGate": true
          }
        ]
      }
    ...
    "topics": [
      {
        ...
        "subtopics": [
          {
            "id": "dft-1-1",
            "title": "Scan Flip-Flop Architecture (Mux-D)",
            "detail": "Understand Scan-In (SI), Scan-Enable (SE), and Scan-Out (SO) pin multiplexing."
          },
          {
            "id": "dft-1-2",
            "title": "Shift vs Capture Test Cycles",
            "detail": "Shift in test vector through scan chain, pulse system clock for 1 capture cycle, shift out response."
          },
          {
            "id": "dft-1-3",
            "title": "ATPG Algorithms (D-Algorithm / PODEM)",
            "detail": "Generate sensitized path vectors that propagate internal gate faults to observable scan outputs."
          },
          {
            "id": "dft-1-4",
            "title": "Exit Gate: >95% ATPG Fault Coverage",
            "detail": "Generate test pattern suite achieving >95% stuck-at fault coverage on target ALU/CPU core.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "dft-2-1",
            "title": "16-State TAP Controller FSM",
            "detail": "Navigate Test-Logic-Reset, Run-Test/Idle, Select-DR-Scan, Capture-DR, Shift-DR, Exit1-DR, Update-DR."
          },
          {
            "id": "dft-2-2",
            "title": "Instruction & Data Register Decoding",
            "detail": "Implement BYPASS, IDCODE, and custom USER1 scan registers."
          },
          {
            "id": "dft-2-3",
            "title": "Boundary Scan Cell Architecture",
            "detail": "Isolate internal core logic from physical package pins for board interconnect testing."
          },
          {
            "id": "dft-2-4",
            "title": "Exit Gate: JTAG TAP Verification Pass",
            "detail": "Verify TAP FSM transitions and IDCODE readout in simulation.",
            "isExitGate": true
          }
        ]
      },
      {
        ...
        "subtopics": [
          {
            "id": "dft-3-1",
            "title": "Integrated Clock Gating (ICG) Cells",
            "detail": "Disable clock tree distribution to idle registers using glitch-free latch-based clock gates."
          },
          {
            "id": "dft-3-2",
            "title": "Power Gating, Isolation & Level Shifters",
            "detail": "Clamp floating signals to safe logic levels (0/1) when crossing from powered-down to active domain."
          },
          {
            "id": "dft-3-3",
            "title": "UPF Power Intent Specification",
            "detail": "Write create_power_domain, set_isolation, set_level_shifter, and create_power_switch commands."
          },
          {
            "id": "dft-3-4",
            "title": "Exit Gate: Power-Aware Simulation Pass",
            "detail": "Simulate power domain shutoff and verify proper isolation clamp without logic corruption.",
            "isExitGate": true
          }
        ]
      }
