import { FlagshipProject, RuleItem, HabitItem, PrepResource } from '../types';
...
export const goldenRules: RuleItem[] = [
  { id: 'R1', rule: 'Academics is strictly protected', meaning: 'Never sacrifice semester exams or GPA for projects. Schedule deep work hours around academic commitments.', action: 'Block fixed 2-3 hour high-focus slots daily; pause projects during exam weeks.', checkFrequency: 'Daily' },
  { id: 'R2', rule: 'No tutorial-only completion', meaning: 'A topic is strictly incomplete until Ayush builds, tests, and validates something in code or silicon.', action: 'Every concept requires an accompanying testbench, schematic, or working driver.', checkFrequency: 'Every Topic' },
  { id: 'R3', rule: 'One deep build at a time', meaning: 'No starting a new flagship project until the current milestone is fully shipped and tested.', action: 'Strict work-in-progress limit of 1 active flagship milestone.', checkFrequency: 'Weekly' },
  { id: 'R4', rule: 'Evidence over claims', meaning: 'Every project bullet on your resume must have tests, waveform traces, measured metrics, and a demo video.', action: 'Upload waveform dumps (VCD), timing reports (WNS), and demo GIFs to GitHub.', checkFrequency: 'Every Milestone' },
  { id: 'R5', rule: 'Existing strengths stay alive', meaning: 'Maintain FireGuard, C/C++ firmware, electronics, and CSE algorithmic foundations while learning FPGA/RTL.', action: 'Spend 30-45 mins maintaining and refactoring existing codebases weekly.', checkFrequency: 'Weekly' },
  { id: 'R6', rule: 'Weekly Sunday Gate', meaning: 'Every Sunday: review hours, update blockers, log progress ticks, and commit next week\'s exit criteria.', action: 'Complete the Sunday Review checklist and commit all Git repositories.', checkFrequency: 'Weekly on Sunday' },
  { id: 'R7', rule: 'Month 5 is integration only', meaning: 'Do not start random, novel technologies in the final month before internship applications.', action: 'Focus 100% on polish, mock interviews, cold outreach, and resume synchronization.', checkFrequency: 'Monthly' },
  { id: 'R8', rule: 'Portfolio is part of engineering', meaning: 'Clean Git commit history, reproducible READMEs, and single-command build scripts are mandatory.', action: 'Write clear commit messages; verify make test works on fresh machines.', checkFrequency: 'Every Commit' },
  { id: 'R9', rule: 'Health is a mathematical constraint', meaning: 'Burnout guarantees failure. Maintain 7 hours of sleep, regular nutrition, and exercise.', action: 'Shutdown work at 11:30 PM; maintain sustainable weekly intensity.', checkFrequency: 'Daily' },
  { id: 'R10', rule: 'Target role decides depth', meaning: 'Prioritize Silicon, FPGA, RTL, and Embedded firmware roles; do not get distracted by generic web/mobile stacks.', action: 'Filter all learning against tier-1 semiconductor and hardware job requirements.', checkFrequency: 'Daily' }
];

export const dailyHabits: HabitItem[] = [
  { id: 'h1', name: 'Deep Core Learning', targetTime: '60–90 min', description: 'Read spec/textbook, analyze architecture diagrams, master new theoretical concept.', category: 'Coding' },
  { id: 'h2', name: 'Hardware / RTL Implementation', targetTime: '60–120 min', description: 'Write synthesizable SystemVerilog, C firmware drivers, or FPGA constraints.', category: 'Coding' },
  { id: 'h3', name: 'Testbench & Verification', targetTime: '30–45 min', description: 'Write assertions, run cocotb / ModelSim simulations, inspect waveform traces.', category: 'System & Projects' },
  { id: 'h4', name: 'Interview Drills / DSA / Puzzles', targetTime: '30 min', description: 'Solve 1-2 whiteboard digital design or embedded C pointer problems under timer.', category: 'Interview & Revision' },
  { id: 'h5', name: 'Engineering Hygiene & Git Docs', targetTime: '15–30 min', description: 'Commit clean code, update READMEs, document measured latency/utilization numbers.', category: 'System & Projects' },
  { id: 'h6', name: 'Daily Review & Exit Gate Check', targetTime: '15 min', description: 'Tick completed subtopics, review next day priority, update journal notes.', category: 'Interview & Revision' }
];

export const prepResources: PrepResource[] = [
  {
    category: 'Digital Design & RTL Synthesis',
    items: [
      { title: 'HDLBits Interactive Problem Set', type: 'Practice Platform', use: 'Practice Verilog/SystemVerilog circuits from basic gates to complex FSMs with live online synthesis.', link: 'https://hdlbits.01xz.net/', keyTakeaways: 'Instant feedback on syntax, simulation, and latch inference.' },
      { title: 'Digital Design & Computer Architecture (Harris & Harris)', type: 'Textbook', use: 'Gold standard textbook for bridging digital logic, RISC-V CPU architecture, and C programming.', keyTakeaways: 'Covers single-cycle, pipelined datapaths, hazards, and memory hierarchies.' },
      { title: 'ZipCPU (Dan Gisselquist Blog)', type: 'Tutorials', use: 'World-class tutorials on formal verification, wishbone/AXI bus protocols, and FPGA debugging.', link: 'https://zipcpu.com/', keyTakeaways: 'Essential for learning practical timing closure and formal proofs.' }
    ]
  },
  {
    category: 'Verification & SystemVerilog / UVM',
    items: [
      { title: 'Verification Academy (Siemens / Mentor)', type: 'Video/Course', use: 'Free comprehensive video courses and cookbook for UVM, SVA, and functional coverage.', link: 'https://verificationacademy.com/', keyTakeaways: 'The definitive industry resource for UVM methodology.' },
      { title: 'cocotb Official Documentation & Tutorials', type: 'Official Docs', use: 'Learn Python coroutine-based hardware verification for rapid testbench development.', link: 'https://docs.cocotb.org/', keyTakeaways: 'Async/await test drivers, golden models, and regression integration.' },
      { title: 'ChipVerify SystemVerilog & UVM Guide', type: 'Tutorials', use: 'Concise, copyable reference code for all SystemVerilog syntax, OOP concepts, and UVM components.', link: 'https://www.chipverify.com/', keyTakeaways: 'Quick syntax lookup for assertions, classes, and interfaces.' }
    ]
  },
  {
    category: 'Embedded C, Architecture & RTOS',
    items: [
      { title: 'Making Embedded Systems (Elecia White)', type: 'Textbook', use: 'Master software patterns, memory management, and hardware interfaces for professional firmware.', keyTakeaways: 'Hardware-software contracts, watchdogs, and state machines.' },
      { title: 'FreeRTOS Official Reference Manual & Kernel Guide', type: 'Official Docs', use: 'Deep dive into preemptive task scheduling, queues, semaphores, and memory allocators.', link: 'https://www.freertos.org/Documentation/RTOS_book.html', keyTakeaways: 'Thread safety, priority inversion prevention, and ISR handling.' },
      { title: 'The RISC-V Reader: An Open Architecture Atlas', type: 'Spec', use: 'Official companion book to the RISC-V ISA specification with concise architectural tables.', keyTakeaways: 'Covers RV32I, RV64I, standard extensions (M, A, F, D, C).' }
    ]
  }
];
